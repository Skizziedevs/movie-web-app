<template>
  <div class="pl-[6px] relative left-[5px] lg:pl-[150px]">
    <div
    ...
    <div
      class="grid grid-cols-2 h-[100%] gap-x-[4px] md:grid-cols-3 lg:grid-cols-4 gap-y-[10px] g lg:gap-x-[32px] lg:gap-y-[40px] w-[370px] md:w-[725px] lg:w-[1240px] mx-auto"
    >
      <div
