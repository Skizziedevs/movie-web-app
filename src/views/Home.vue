...
const handleSearch = () => {
  ...
  filteredSearchResults.value = movies.filter((movie) =>
  ...
  <body class="pl-[6px] lg:pl-[150px]">
    <div class="pt-[26px] md:w-[725px] lg:ml-[0px] mx-auto">
      <font-awesome-icon
        ...
        class="text-[18px] pr-[24px] md:text-[24px] text-white"
      />
      <input
        type="text"
        name="search"
        ...
        class="search-text bg-black focus:outline-none text-white text-lg w-[299px] md:w-[320px] h-[36px] md:my-[30px]"
      />
    </div>
    ...
    <template v-else>
      ...
      <div class="w-[370px] md:w-[725px] lg:w-[1240px] mx-auto">
        <h2
          class="text-[20px] md:text-[32px] regular text-white"
          @click="handleSearch()"
        >
          Found '{{ filteredSearchResults.length }}' for {{ searchQuery }}
        </h2>
      </div>
      <div class="bg-black h-[100%] min-h-[100vh]">
        <div
          class="grid grid-cols-2 gap-x-[4px] relative left-[5px] md:grid-cols-3 lg:grid-cols-4 gap-y-[10px] g lg:gap-x-[32px] lg:gap-y-[40px] w-[370px] md:w-[725px] lg:w-[1240px] mx-auto"
        >
          <div
