<template>
  <div class="login-wrapper">
    <div
      class="box w-[327px] bg-smokeblack mx-auto items-center my-auto h-[362px] flex-shrink-0 rounded-[10px] md:w-[400px] md:h-[388px]"
    >
      <h2 class="pt-[24px] pl-[24px] md:pt-[38px] md:pl-[32px] pb-[33px]">
        Login
      </h2>
        ...
        <div class="text-center pt-[21px]">
          <h3 class="text-white">
            ...
            <router-link to="/signup">
              <span class="text-pinkishred">Sign up</span></router-link
            >
          </h3>
...
function validateForm() {
  if (!isValidEmail(email.value)) {
    ...
    router.push('/home'); // Correct way to navigate to a path
  }
}
